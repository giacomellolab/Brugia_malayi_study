...
See "V10F24_041_spots_seurat_metadata.xlsx" in the github directory "https://github.com/giacomellolab/Brugia_malayi_study/tree/main/data" for how the spot section metadata ends up (from the code below)
...
write.csv(all_sections_subset_QC@meta.data[,], file = "V10F24_041_spots_seurat_metadata.csv")

write.xlsx(all_sections_subset_QC@meta.data[,], file = "V10F24_041_spots_seurat_metadata.xlsx", col.names=TRUE, row.names=TRUE)
