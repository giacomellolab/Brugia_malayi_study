...
The outputs are the integration features from SelectIntegrationFeatures, output of PrepSCTIntegration, and the normalized rds object of brugia count matrix and metadata. The normalized rds object of brugia count matrix and metadata are used in the next script 5_treated_worm_analysis_r_linux.Rmd.