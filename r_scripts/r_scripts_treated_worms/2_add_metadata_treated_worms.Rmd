...
write.csv(all_sections_subset.section.labeled@meta.data[,], file = "Ctrl_treated_metadata.csv")

write.xlsx(all_sections_subset.section.labeled@meta.data[,], file = "Ctrl_treated_metadata.xlsx", col.names=TRUE, row.names=TRUE)
...
write.csv(all_sections_subset_QC@meta.data[,], file = "Ctrl_treated_extended_metadata.csv")

write.xlsx(all_sections_subset_QC@meta.data[,], file = "Ctrl_treated_extended_metadata.xlsx", col.names=TRUE, row.names=TRUE)
