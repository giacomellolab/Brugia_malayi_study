...
Output is the deferentially expressed brugia genes in Wolbachia+ verus Wolbachia- spots in an excel file and as an rds object, and is shown in Supplementary Table 6. The output is used to generate the plots for Figure 5A-D. 
