...
The outputs are the dimensionally reduced, integrated with harmony rds object with clusters and the deferentially expressed marker genes per cluster in an excel file. The dimensionally reduced, integrated with harmony rds object of brugia count matrix and metadata is used to make the plots shown in Figure 2A-B, Figure 2F, for the functional term enrichment analysis performed to generate Figure 2E and Supplementary Table 3, Figure 3A-D, and Supplementary Figure 1. The output of the deferentially expressed marker genes per cluster in an excel file is Supplementary 2 and were used to make plot Figure 2C.
