...
The outputs are the dimensionally reduced, integrated with harmony rds object with clusters and the deferentially expressed marker genes per cluster in an excel file. The dimensionally reduced, integrated with harmony rds object of brugia count matrix and metadata is used to make the plots shown in Figure 2A-C, for the functional term enrichment analysis performed to generate Figure 2E and Supplementary Table 4, Figure 3A-F, and Figure 4A-D. The output of the deferentially expressed marker genes per cluster in an excel file is Supplementary Table 3 and were used to make plot Figure 2D.
